...
contract ConsoleNFT_Cyber_Upgrades is ERC721Enumerable, ReentrancyGuard, Ownable, VRFConsumerBase {
	...
	function whitelistClaim(bytes32[] memory proof, uint8 proofNumber) public nonReentrant payable {
    ...
    function vaultHolderClaim(bytes32[] memory proof, uint8 proofNumber, uint[] memory vaultIds) public nonReentrant {
        require(whitelistMintStart < block.timestamp, "The whitelist mint did not start yet");
    ...
    function vaultHolderClaimCombined(bytes32[] memory proof, uint8 proofNumber, uint[] memory vaultIds) public nonReentrant payable {
        require(whitelistMintStart < block.timestamp, "The whitelist mint did not start yet");
